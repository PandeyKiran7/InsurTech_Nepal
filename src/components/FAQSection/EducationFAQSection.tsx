    ...
    <div className="bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-indigo-100 text-black rounded-lg p-6 mb-6 shadow-md">
          ...
          <p className="text-xl">
            AI in education refers to the use of artificial intelligence technologies like machine learning, natural language processing,
            and data analytics to enhance teaching and learning experiences.
          </p>
        </div>
