    ...
    <div className="bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-indigo-100 text-black rounded-lg p-6 mb-6 shadow-md">
          ...
          <p className="text-xl">
            E-commerce technology refers to the tools, platforms, and systems used to conduct business transactions online.
            It includes shopping carts, payment gateways, recommendation engines, chatbots, and AI-driven analytics that enhance
            the shopping experience, streamline operations, and optimize sales.
          </p>
        </div>
