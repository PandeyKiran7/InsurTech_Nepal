          ...
          {locations.map((location, index) => (
            <div key={index} className="bg-white rounded-lg shadow-2xl p-6">
              ...
              {location.addressLine1 && (
                <p className="text-gray-600 text-sm mb-1">{location.addressLine1}</p>
              )}
              {location.addressLine2 && (
                <p className="text-gray-600 text-sm mb-2">{location.addressLine2}</p>
              )}
              {location.phone && (
                <p className="text-gray-600 text-sm mb-1">Phone: {location.phone}</p>
              )}
              {location.email && (
