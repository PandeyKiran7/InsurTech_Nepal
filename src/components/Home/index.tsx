      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-2">Our Flagship Solutions</h2>
            <p className="text-gray-600">
              Comprehensive insurance technology solutions designed for the modern digital age
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: <FaShieldAlt className="text-4xl text-blue-600 mb-4 mx-auto" />,
                title: "iSolution",
                description:
              ...
              {
                icon: <FaMobileAlt className="text-4xl text-teal-600 mb-4 mx-auto" />,
                title: "eBeema",
                description:
              ...
              {
                icon: <FaRobot className="text-4xl text-yellow-500 mb-4 mx-auto" />,
                title: "AI Chatbot",
                description:
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Trusted by leading insurance companies across Nepal</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                text:
                  '"Thanks to Insurtech Nepal, we streamlined our entire policy issuance process and reduced processing time by 70%."',
                author: "Rajesh Sharma",
                company: "CEO, Himalayan Life Insurance",
              },
              {
                text:
                  '"The eBeema platform has revolutionized how we reach customers. Our online sales increased by 300% in just six months."',
                author: "Priya Thapa",
                company: "Digital Head, Everest General Insurance",
              },
              {
                text:
                  '"Insurtech Nepal\'s solutions are robust, scalable, and perfectly tailored for the Nepalese insurance market."',
                author: "Arjun Pandey",
