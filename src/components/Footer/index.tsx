...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#44c9c0] text-white ">
      <div className="container mx-auto px-2 max-w-screen-xl pb-16 pt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 p-4">
              ...
              {[FaFacebook, FaInstagram, FaTwitter, FaLinkedin].map(
                (Icon, index) => (
                  <a
                    key={index}
                    href="#"
                    className="items-center mt-6 hover:bg-[#44c9c0] rounded-md transition-colors duration-200"
                  >
          ...
          <div className="space-y-4 ml-12 mr-4">
            <h3 className="text-2xl font-semibold text-white w-24">Services</h3>
            <span className="block w-10  border-b-4 border-white pb-1"></span>
              ...
              {[
                ...
                <li
                  ...
                  className={`text-white text-base transition-colors duration-300 ${
                    index !== arr.length ? "border-b  border-white pb-4" : ""
                  }`}
                >
        ...
        <div className="w-full border-1 border-white mt-6 mb-1.5"></div>
